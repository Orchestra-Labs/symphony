...
// source: symphony/icaoracle/icaoracle.proto
...
func (MetricStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a166b56e448fb089, []int{0}
}
...
type Metric struct {
	...
	Status            MetricStatus `protobuf:"varint,8,opt,name=status,proto3,enum=symphony.icaoracle.MetricStatus" json:"status,omitempty"`
}
...
func (*Metric) Descriptor() ([]byte, []int) {
	return fileDescriptor_a166b56e448fb089, []int{1}
}
...
func (*RedemptionRateAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_a166b56e448fb089, []int{2}
}
...
func init() {
	proto.RegisterEnum("symphony.icaoracle.MetricStatus", MetricStatus_name, MetricStatus_value)
	proto.RegisterType((*Oracle)(nil), "symphony.icaoracle.Oracle")
	proto.RegisterType((*Metric)(nil), "symphony.icaoracle.Metric")
	proto.RegisterType((*RedemptionRateAttributes)(nil), "symphony.icaoracle.RedemptionRateAttributes")
}

func init() {
	proto.RegisterFile("symphony/icaoracle/icaoracle.proto", fileDescriptor_a166b56e448fb089)
}

var fileDescriptor_a166b56e448fb089 = []byte{
	// 559 bytes of a gzipped FileDescriptorProto
	,
}
