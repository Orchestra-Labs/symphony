...
var (
	pattern_Msg_Deposit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"symphony", "collateral", "v1beta1", "deposit"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_Withdraw_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"symphony", "collateral", "v1beta1", "withdraw"}, "", runtime.AssumeColonVerbOpt(false)))
)
